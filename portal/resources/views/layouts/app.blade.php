            ...
            <main class="flex-1 p-4 sm:p-6 lg:p-8">
                ...
                @if(session('error'))
                    <div class="mb-6 flex items-start gap-3 rounded-lg border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-800 flash flash-persist">
                        ...
                        <button onclick="(function(btn){var text='Page: '+window.location.pathname+'\nError: '+btn.closest('.flash-persist').querySelector('span').textContent.trim();navigator.clipboard.writeText(text).then(function(){btn.textContent='Copied!';setTimeout(function(){btn.textContent='Copy'},1500)})})(this)" class="text-red-500 hover:text-red-700 transition shrink-0 text-xs font-medium border border-red-300 rounded px-2 py-0.5">Copy</button>
