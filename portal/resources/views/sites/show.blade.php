...
<div class="rounded-xl border border-gray-200 bg-white shadow-sm mb-6">
    <button type="button" id="zip-toggle"
        ...
        aria-expanded="false" aria-controls="zip-panel">
        ...
        <svg id="zip-chevron" class="h-4 w-4 text-gray-400 transition-transform duration-200" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
        </svg>
    </button>

    <div id="zip-panel" class="hidden px-6 pb-6 sm:pl-[4.5rem]">
...
<div class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm mb-6">
    <div class="flex items-center gap-3 mb-4">
        ...
        <h2 class="text-base font-semibold text-gray-900">GitHub</h2>
    </div>
    ...
    @else
        ...
        <p class="text-sm text-gray-500 mb-4 ml-12">Connect a GitHub repository to auto-create releases on push to the default branch.</p>
        <div class="ml-12">
